...
TransformationTestControls::TransformationTestControls()
    ...
    mlayout.add_item(2, 0, {mtranslation_x_value_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(0, 1, {mtranslation_y_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(1, 1, {mtranslation_y, lgui::Align::VCenter});
    mlayout.add_item(2, 1, {mtranslation_y_value_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(0, 2, {mrotation_z_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(1, 2, {mrotation_z, lgui::Align::VCenter});
    mlayout.add_item(2, 2, {mrotation_z_value_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(0, 3, {mrotation_y_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(1, 3, {mrotation_y, lgui::Align::VCenter});
    mlayout.add_item(2, 3, {mrotation_y_value_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(0, 4, {mrotation_x_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(1, 4, {mrotation_x, lgui::Align::VCenter});
    mlayout.add_item(2, 4, {mrotation_x_value_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(0, 5, {mscale_x_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(1, 5, {mscale_x, lgui::Align::VCenter});
    mlayout.add_item(2, 5, {mscale_x_value_lbl, lgui::Align::VCenter | lgui::Align::Right});
    mlayout.add_item(0, 6, {mscale_y_lbl, lgui::Align::VCenter | lgui::Align::Right});
